...
def test_parse_es_response(es_response):
    ...
    data = {'hostname': ['reuters.com', 'nytimes.com', 'politico.com', 'applevacations.com', 'bananavacations.com'],
            u'query': [['apple'], ['carrot'], ['apple', 'banana'], ['apple', 'banana'], ['banana']],
            u'tag': [['Untagged'], ['Untagged'], ['Relevant'], ['Irrelevant', 'Relevant'], ['Irrelevant', 'Relevant']],
            'tld': [u'.com', u'.com', u'.com', u'.com', u'.com'],
            'url': ['http://www.reuters.com/article/us-apple-encryption-hearing-idUSKCN0XB2RU',
                    'http://www.nytimes.com/article/us-apple-encryption-hearing-idUSKCN0XB2RU',
                    'http://www.politico.com/story/2016/04/apple-hires-cynthia-hogan-221937',
                    'http://www.applevacations.com/',
                    'http://www.bananavacations.com/']}
...
def test_calculate_query_correlation(es_response):
    ...
    graph = calculate_query_correlation(df2, 'query')
...
def test_duplicate_multitag_rows(es_response):
    ...
    assert df2.shape == (7,5)
    assert df2.tag.tolist() == ["Untagged", "Untagged", u'Relevant',
